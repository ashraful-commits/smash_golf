    ...
    <MaxWidthContainer className="mix-w-full mt-[-98px] min-h-[331px]">
      <div className="w-full h-full  relative z-0 overflow-hidden">
        ...
        <div className="heroText z-20 absolute bottom-0 flex flex-col items-center w-full">
          ...
          <Button className="text-[65.082px] text-[#000] hover:scale-105 transition-all duration-500 ease-in-out tracking-[3.905px] uppercase bg-[#3F83F8] w-[922px] h-[132.876px] rounded-tl-[65.082px] rounded-br-[65.082px] mb-[32px] flex justify-center items-center font-['Russo_one']">
            play compete. win
          </Button>
        </div>
      </div>
