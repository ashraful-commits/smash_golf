    ...
    <MaxWidthContainer className="w-[1350px] max-h-full bg-[#13131A] px-[40px] pt-[49px]">
      {isLoading ? (
        <div className="flex flex-col">
          <Skeleton className="w-[400px] h-[20px] mt-4 bg-gray-800" />
          <div className="flex justify-between items-center mt-5">
            <Skeleton className="w-[844px] h-[370px] bg-gray-800" />
            <Skeleton className="w-[410px] h-[370px] bg-gray-800" />
          </div>
          <Skeleton className="w-[400px] h-[20px] mt-4 bg-gray-800" />
          <div className="flex justify-between items-center mt-5">
            <Skeleton className="w-[304px] h-[370px] bg-gray-800" />
            <Skeleton className="w-[304px] h-[370px] bg-gray-800" />
            <Skeleton className="w-[304px] h-[370px] bg-gray-800" />
            <Skeleton className="w-[304px] h-[370px] bg-gray-800" />
          </div>
          ...
          <div className="flex justify-between items-center mt-5">
            <Skeleton className="w-[304px] h-[370px] bg-gray-800" />
            <Skeleton className="w-[304px] h-[370px] bg-gray-700" />
            <Skeleton className="w-[304px] h-[370px] bg-gray-700" />
            <Skeleton className="w-[304px] h-[370px] bg-gray-700" />
          </div>
        </div>
              ...
              {sliderList.map((item, i) => {
                return (
                  <div
                    key={i}
                    className={` ${
                      slider === i ? "absolute  top-0 left-0  " : ""
                    }`}
                  >
