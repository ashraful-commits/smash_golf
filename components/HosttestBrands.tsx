...
const HosttestBrands = () => {
  return (
    <MaxWidthContainer className="w-full min-h-[375px] overflow-hidden z-0 relative px-[80px]">
      <Image
      ...
      <div className="brands mt-[45px] w-full h-full flex relative z-[50] justify-end gap-[42px] px-[70px]">
        <Image className="w-auto h-auto" src={brand1} alt="brand1" />
        <Image className="w-auto h-auto" src={brand2} alt="brand2" />
        <Image className="w-auto h-auto" src={brand3} alt="brand3" />
        <Image className="w-auto h-auto" src={brand4} alt="brand4" />
        <Image className="w-auto h-auto" src={brand5} alt="brand5" />
        <Image className="w-auto h-auto" src={brand6} alt="brand6" />
      </div>
      <Button className="font-['Russo_one'] text-center w-[190px] h-[50px] ml-32 bg-[#3f83f8] shrink-0 relative z-[50] mt-[45px] ">
        Shop now
      </Button>
    </MaxWidthContainer>
  );
