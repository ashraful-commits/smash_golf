        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          >
            <div className="flex flex-col gap-4 p-4 md:p-8">
              ...
              <div className="mb-3">
            <p className="text-white py-5">_______________ or sign in _______________</p> 
            <button onClick={()=>signIn("google")} className="flex flex-wrap justify-center w-full items-center gap-3  text-white bg-gray-900 hover:border-gray-500 px-2 py-1.5 rounded-md">
...
Sign in with Google
            ...
            <button onClick={()=>signIn("facebook")} className="flex mt-2 flex-wrap justify-center w-full text-blue-500 bg-gray-900 items-center gap-3 hover:border-gray-500 px-2 py-1.5 rounded-md">
